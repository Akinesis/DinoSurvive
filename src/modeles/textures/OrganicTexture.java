...
public class OrganicTexture implements TexturesGenerator {
	...
	public float[] genTexture(float indiceTextX, float indiceTextY) {
		...
		return new float[]{
				//north
				0.40625f+indiceTextX, 0.09375f+indiceTextY,
				0.40625f+indiceTextX, 0.0625f+indiceTextY,
				0.375f+indiceTextX, 0.09375f+indiceTextY,
				0.375f+indiceTextX, 0.09375f+indiceTextY,
				0.40625f+indiceTextX, 0.0625f+indiceTextY,
				0.375f+indiceTextX, 0.0625f+indiceTextY,
